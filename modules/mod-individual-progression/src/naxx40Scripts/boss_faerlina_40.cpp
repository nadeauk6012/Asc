...
enum Spells
{
    ...
    SPELL_SHADOWBOLT_VOLLEY             = 825586,
};

enum SpellValues : int32
{
    POISON_BOLT_VOLLEY_BP0              = 1484,
    POISON_BOLT_VOLLEY_BP1              = 446,
...
public:
    ...
    struct boss_faerlina_40AI : public BossAI
    {
        ...
        void JustEngagedWith(Unit* who) override
        {
            ...
            events.ScheduleEvent(EVENT_SHADOWBOLT_VOLLEY, urand(12000, 14000));
