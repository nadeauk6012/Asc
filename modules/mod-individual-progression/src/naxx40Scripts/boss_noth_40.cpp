...
enum Events
{
    ...
    EVENT_SHADOW_DEATH                      = 10,
    EVENT_SHADOW_DEATH_TWO                  = 11
...
public:
    ...
    struct boss_noth_40AI : public BossAI
    {
        ...
        void StartBalconyPhase()
        {
            ...
            events.ScheduleEvent(EVENT_SHADOW_DEATH_TWO, 5s);
        }
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            switch (events.ExecuteEvent())
            {
                ...
                case EVENT_BALCONY_SUMMON_ANNOUNCE:
                    ...
                    break;
                case EVENT_SHADOW_DEATH_TWO:
                    DoCastSelf(SPELL_SHADOW_DEATH);
                    events.ScheduleEvent(EVENT_SHADOW_DEATH, 6s);
                    break;
